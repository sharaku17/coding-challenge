              ...
              <ul>
                ...
                >
                  <div className="secondary-t">
                    ...
                    <Link  href="/">
                    <span  className="mt-6 font-semibold uppercase hover:cursor-pointer spacing-wide">Go back</span> 
                    ...
                    <div className="flex items-center mt-6 font-bold ">
                      ...
                      <div>
                        <span className="text-4xl uppercase ">{data?.episode?.name}</span>{" "}
                        <br></br>
                      ...
                      {data?.episode?.characters.map((character) => {
                        ...
                        <div className="w-20 h-20 m-3">
                          <Link href={`/characters/${character?.id}`}>
                            <a>
                          <Image width={150} height={150} className="rounded-full" src={character?.image as string}>
                          </Image>
                          </a>
                          </Link>
